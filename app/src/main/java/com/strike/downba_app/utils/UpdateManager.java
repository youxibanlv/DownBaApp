...
import com.strike.downba_app.http.req.VersionReq;
import com.strike.downba_app.http.rsp.VersionRsp;
    ...
    public void checkUpdate(final boolean notify) {
        ...
        req.sendRequest(new NormalCallBack() {
            ...
            public void onSuccess(String result) {
                VersionRsp rsp = (VersionRsp) BaseRsp.getRsp(result, VersionRsp.class);
                ...
                if (serverVersion != null) {
                    if (serverVersion.getVersion_code() > localVersion.getVersion_code()) {
                        ...
                        //提示更新
                        if (notify) {
                            new YesNoDialog(mContext, "检测到新版本", version.getVersion_info(), "取消", "更新",
                                    false, null, new CustomDialogClickListener() {
                                @Override
